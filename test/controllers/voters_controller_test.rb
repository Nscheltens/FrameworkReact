...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { email: @voter.email, hasvote: @voter.hasvote } }, as: :json
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { email: @voter.email, hasvote: @voter.hasvote } }, as: :json
    assert_response 200
  end
