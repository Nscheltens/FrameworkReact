...
class FrameworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create framework" do
    assert_difference('Framework.count') do
      post frameworks_url, params: { framework: { name: @framework.name, vote: @framework.vote } }, as: :json
    end
  ...
  test "should update framework" do
    patch framework_url(@framework), params: { framework: { name: @framework.name, vote: @framework.vote } }, as: :json
    assert_response 200
  end
